...
//			Instructor teInstructor=new Instructor("aman","kumar","aman@gmail.com");
			...
			InstructorDetails tempinInstructorDetails=new InstructorDetails("http://youtube.yahoo"
					,"TableTennis");
			Instructor teInstructor=new Instructor("sunidhi","mishra","Somi@gmail.com");
